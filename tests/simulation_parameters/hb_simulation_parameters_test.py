from simulation_parameters import HbSimulationParameters
...
class TestHbSimulationParameters:
    ...
    def test_single_frequency_directive(self):
        # arrange
        params = HbSimulationParameters(frequencies=("1MEG",))
        # act
    ...
    def test_multiple_frequencies_directive(self):
        # arrange
        params = HbSimulationParameters(frequencies=("1MEG", "2MEG", "500K"))
        # act
        directives = params.to_xyce_directives()
        # assert
