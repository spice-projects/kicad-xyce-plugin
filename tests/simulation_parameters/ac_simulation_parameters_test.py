from simulation_parameters import AcSimulationParameters
...
class TestAcSimulationParameters:
    ...
    def test_lin_directive_default(self):
        # arrange
        params = AcSimulationParameters(sweep_mode="LIN", points="100", start="1", end="1MEG")
        # act
    ...
    def test_dec_directive(self):
        # arrange
        params = AcSimulationParameters(sweep_mode="DEC", points="10", start="1k", end="100MEG")
        # act
        directives = params.to_xyce_directives()
        # assert
    ...
    def test_oct_directive(self):
        # arrange
        params = AcSimulationParameters(sweep_mode="OCT", points="5", start="1", end="1MEG")
        # act
        directives = params.to_xyce_directives()
        # assert
    ...
    def test_data_directive(self):
        # arrange
        params = AcSimulationParameters(sweep_mode="DATA", data_table_name="myTable")
        # act
        directives = params.to_xyce_directives()
        # assert
