...
from kicad_xyce_plugin.decimation_algorithm import DecimationAlgorithm, decimate, decimate_xy
...
def test_xy_lttb_passes_x_through_unchanged():
    ...
    captured_x = []
    # act
    with patch("kicad_xyce_plugin.decimation_algorithm._lttb_indices") as mock_lttb:
