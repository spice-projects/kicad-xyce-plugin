...
//     bool is_subset_of(const std::span<const double>& output, const std::span<const double>& original) {
//         const std::unordered_set<double> original_set(original.begin(), original.end());
//         for (double v : output)
//             if (original_set.find(v) == original_set.end())
//                 return false;
//         return true;
//     }

//     // return true when every (x, y) pair in the output also appears in the original
//     bool xy_pairs_coherent(const std::span<const double>& x_out, const std::span<const double>& y_out, const std::span<const double>& x_orig, const std::span<const double>& y_orig) {
...
// TEST(DecimateXYChecks, average_short_circuit_returns_original_spans) {
//     // arrange
//     auto y = make_sine(50);
//     auto x = make_linspace(50);
//     // act
//     auto [x_out, y_out] = decimate_xy(x, y, 50, DECIMATE_AVERAGE);
//     // assert
//     ASSERT_EQ(x_out.data(), x.data());
//     ASSERT_EQ(y_out.data(), y.data());
// }
...
// TEST(DecimateXYChecks, average_output_length_le_target) {
//     // arrange
//     auto y = make_sine(10000);
//     auto x = make_linspace(10000);
//     // act
//     auto [x_out, y_out] = decimate_xy(x, y, 100, DECIMATE_AVERAGE);
//     // assert
//     ASSERT_LE(x_out.size(), 100u);
//     ASSERT_LE(y_out.size(), 100u);
// }
...
// TEST(DecimateXYChecks, average_output_x_and_y_have_equal_length) {
//     // arrange
//     auto y = make_sine(10000);
//     auto x = make_linspace(10000);
//     // act
//     auto [x_out, y_out] = decimate_xy(x, y, 200, DECIMATE_AVERAGE);
//     // assert
//     ASSERT_EQ(x_out.size(), y_out.size());
// }
...
//     // assert
//     ASSERT_DOUBLE_EQ(y_out.front(), y.front());
//     ASSERT_DOUBLE_EQ(y_out.back(), y.back());
// }
...
// TEST(DecimateXYChecks, average_output_values_are_bucket_means) {
//     // arrange
//     size_t n = 100;
//     std::vector<double> y(n);
//     std::iota(y.begin(), y.end(), 0.0);
//     auto   x      = make_linspace(n);
//     size_t target = 10;
//     // act
//     auto [x_out, y_out] = decimate_xy(x, y, target, DECIMATE_AVERAGE);
//     // assert — each output point must equal the mean of its 10-element bucket
//     ASSERT_EQ(y_out.size(), 10u);
//     for (size_t b = 0; b < 10; ++b) {
//         double expected = 0.0;
//         for (size_t i = 0; i < 10; ++i)
//             expected += y[b * 10 + i];
//         expected /= 10.0;
//         ASSERT_NEAR(y_out[b], expected, 1e-10);
//     }
// }

// TEST(DecimateXYChecks, average_large_input_output_length_le_target) {
//     // arrange
//     auto y = make_sine(10000);
//     auto x = make_linspace(10000);
//     // act
...
// TEST(DecimateXYChecks, average_flat_signal_unchanged_values) {
//     // arrange
//     std::vector<double> y(1000, 7.0);
//     auto x = make_linspace(1000);
//     // act
//     auto [x_out, y_out] = decimate_xy(x, y, 50, DECIMATE_AVERAGE);
//     // assert
//     for (double v : y_out)
//         ASSERT_NEAR(v, 7.0, 1e-10);
// }

// TEST(DecimateXYChecks, average_output_values_not_from_original) {
//     // arrange
//     size_t n = 100;
//     std::vector<double> y(n);
//     std::iota(y.begin(), y.end(), 0.0);
...
//     // act
//     auto [x_out, y_out] = decimate_xy(x, y, target, DECIMATE_AVERAGE);
//     // assert — averaged values (like 4.5, 14.5 ...) must not appear in the original integer sequence
//     const std::unordered_set<double> original_set(y.begin(), y.end());
//     for (double v : y_out)
//         ASSERT_EQ(original_set.find(v), original_set.end());
// }

// TEST(DecimateXYChecks, average_x_values_are_bucket_centroids) {
//     // arrange
//     size_t n = 100;
...
//     // act
//     auto [x_out, y_out] = decimate_xy(x, y, target, DECIMATE_AVERAGE);
//     // assert — each x output must be the mean of its bucket's x values
//     ASSERT_EQ(x_out.size(), 10u);
//     for (size_t b = 0; b < 10; ++b) {
//         double expected_x = 0.0;
//         for (size_t i = 0; i < 10; ++i)
//             expected_x += x[b * 10 + i];
//         expected_x /= 10.0;
//         ASSERT_NEAR(x_out[b], expected_x, 1e-10);
//     }
// }
...
//     ASSERT_THROW(decimate_xy(x, y, 5, DECIMATE_AVERAGE), std::invalid_argument);
