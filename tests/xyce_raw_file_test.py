...
from xyce_raw_file import AbscissaScale, PlotSuggestion, StepInformation, VariableType, VariableTypeInformation, XyceRawFile, _parse_ascii_variables, _parse_binary_variables, _process_scale, _process_steps, _steps_have_consistent_abscissa_direction
