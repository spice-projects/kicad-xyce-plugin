from .op_simulation_parameters import NodesetEntry, OpSimulationParameters
...
class OpPanel:
    ...
    def handle_submit(self, print_enabled: bool, print_all_nodes: bool, print_all_currents: bool, print_power: bool, print_bjt_leads: bool, print_fet_leads: bool, print_specific_vars: str, print_format: str, print_file: str, save_enabled: bool, save_type: str, nodeset_text: str, save_file: str, replace_ground: bool) -> OpSimulationParameters:
        ...
        analysis = OpSimulationParameters(save_enabled=save_enabled, save_type=save_type, save_file=save_file.strip(), nodeset_entries=tuple(nodeset_entries), print_parameters=print_parameters, replace_ground=replace_ground)
