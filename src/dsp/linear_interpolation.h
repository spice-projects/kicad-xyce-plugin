...
{
    /**
     * @brief Interpolates multiple signals from a non-uniform grid to a uniform grid using piecewise linear interpolation.
    ...
    /**
     * @brief Interpolates a single signal from a non-uniform grid to a uniform grid using piecewise linear interpolation.
     * @param x_old Non-uniform, strictly increasing abscissa values (e.g. time steps from SPICE).
