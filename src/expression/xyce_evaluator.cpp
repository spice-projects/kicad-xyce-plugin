...
namespace
{
    ...
    // Forward declarations of evaluation functions to support recursion in anonymous namespace
    ...
    bool is_probe_call(const FunctionCallNode& expression);
    [[maybe_unused]] bool has_simple_probe_args(const FunctionCallNode& expression);
    ...
    [[maybe_unused]] XyceValue boolean_result(bool value);
    XyceValue truth_mask(const XyceValue& value);
    [[maybe_unused]] XyceValue apply_unary_numeric(const XyceValue& value, const std::function<std::complex<double>(std::complex<double>)>& fn);
    XyceValue apply_binary_numeric(const XyceValue& left, const XyceValue& right, const std::function<std::complex<double>(std::complex<double>, std::complex<double>)>& fn);
